                        ...
                        children: [
                          const SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: CircleAvatar(
                                  backgroundImage:
                                      AssetImage("images/sashimi.jpeg")),
                            ),
                          ),
                          const Padding(
                        ...
                        children: [
                          const SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: CircleAvatar(
                                  backgroundImage:
                                      AssetImage("images/nigiri.webp")),
                            ),
                          ),
                          const Padding(
                            padding:
                                EdgeInsets.only(right: 30, top: 12, left: 15),
                            child: Text(
                              "Nigiri",
                              style: TextStyle(
                                  fontWeight: FontWeight.bold, fontSize: 18),
                        ...
                        children: [
                          const SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: CircleAvatar(
                                  backgroundImage:
                                      AssetImage("images/chirashi.jpg")),
                            ),
                          ),
                          const Padding(
                        ...
                        children: [
                          const SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: CircleAvatar(
                                  backgroundImage:
                                      AssetImage("images/uramaki.webp")),
                            ),
                          ),
                          const Padding(
                            padding: EdgeInsets.only(
                        ...
                        children: [
                          const SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: CircleAvatar(
                                  backgroundImage:
                                      AssetImage("images/termaki.webp")),
                            ),
                          ),
                          const Padding(

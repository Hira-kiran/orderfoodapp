...
class Tikka extends StatelessWidget {
  const Tikka({super.key});
                        ...
                        children: [
                          const SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: CircleAvatar(
                                  backgroundImage:
                                      AssetImage("images/chickentikka.webp")),
                            ),
                          ),
                          const Padding(
                        ...
                        children: [
                          const SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: CircleAvatar(
                                  backgroundImage:
                                      AssetImage("images/tanduritikka.jpg")),
                            ),
                          ),
                          const Padding(
                            padding:
                        ...
                        children: [
                          const SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: CircleAvatar(
                                  backgroundImage:
                                      AssetImage("images/reshmitikka.webp")),
                            ),
                          ),
                          const Padding(
                            padding: EdgeInsets.only(right: 10),
                        ...
                        children: [
                          const SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: CircleAvatar(
                                  backgroundImage:
                                      AssetImage("images/malaitikka.jpg")),
                            ),
                          ),
                          const Padding(
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.only(top: 55, left: 40),
                                child: Container(
                                    height: 27,
                                    width: 27,
                                    decoration: BoxDecoration(
